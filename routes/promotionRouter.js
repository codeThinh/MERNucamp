...
promotionRouter
  ...
  .put(authenticate.verifyUser, (req, res) => {
    res.statusCode = 403;
    res.end("PUT operation don't work on /promotions");
  })
...
//     res.statusCode = 403;
//     res.end(
//       `PUT operation don't work on /promotions/${req.params.promotionId}/comments`
//     );
//   })
//   .delete((req, res, next) => {
//     Promotion.findById(req.params.promotionId)
...
//     res.statusCode = 403;
//     res.end(
//       `POST operation don't work on /promotions/${req.params.promotionId}/comments/${req.params.commentId}`
//     );
//   })
//   .put((req, res, next) => {
//     Promotion.findById(req.params.promotionId)
