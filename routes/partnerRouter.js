...
partnerRouter
  ...
  .put((req, res) => {
    res.statusCode = 403;
    res.end("PUT operation don't work on /partners");
  })
...
//     res.statusCode = 403;
//     res.end(
//       `PUT operation don't work on /partners/${req.params.partnerId}/comments`
//     );
//   })
//   .delete((req, res, next) => {
//     Partner.findById(req.params.partnerId)
...
//     res.statusCode = 403;
//     res.end(
//       `POST operation don't work on /partners/${req.params.partnerId}/comments/${req.params.commentId}`
//     );
//   })
//   .put((req, res, next) => {
//     Partner.findById(req.params.partnerId)
